...
public class FeedItemLinkActivity extends Activity implements OnItemClickListener,OnClickListener{
        ...
        if(onrotaion){
            ...
            if( !isOnline){
                if( !Constants.FEED_TYPE_ARTICLE.equals(currentFeed.getType())){
                    Toast.makeText(FeedItemLinkActivity.this, getResources().getString(R.string.no_internet_msg), Toast.LENGTH_LONG).show();
                }
            }
    ...
    public PopupWindow initLinkPopup(){
        ...
        View layout = layoutInflater.inflate(R.layout.popup_open_link, (ViewGroup)findViewById(R.layout.feed_item_layout));
    ...
    public void displayPopupControl(){
        ...
        View layout = layoutInflater.inflate(R.layout.popup_control, (ViewGroup)findViewById(R.layout.feed_item_layout));
        ...
        tableRowHomeId.setOnClickListener(new OnClickListener(){
            public void onClick(View v){
                Intent intent = new Intent(FeedItemLinkActivity.this, MainActivity.class);
    ...
    public void displayGoToPagePopup(){
        LayoutInflater layoutInflater = (LayoutInflater)getBaseContext().getSystemService(LAYOUT_INFLATER_SERVICE);
        View layout = layoutInflater.inflate(R.layout.popup_goto_page, (ViewGroup)findViewById(R.layout.feed_item_layout));
    ...
    private void backAction(){
        ...
        Intent intent = new Intent(FeedItemLinkActivity.this, FeedMainItemActivity.class);
        //FEED_TITLE,FEED_ID
    ...
    public void saveBookmark(boolean showMsg){
        ...
        if(showMsg){
            ...
            Toast.makeText(FeedItemLinkActivity.this, msg, Toast.LENGTH_LONG).show();
        }
        /** Update to Database **/
        ContentValues values = new ContentValues();
        //values.put(DBSchema.ItemSchema.COLUMN_UPDATE_DATE,(new Date()).getTime());
