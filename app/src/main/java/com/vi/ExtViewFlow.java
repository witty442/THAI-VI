 ...
 * 
 */
public class ExtViewFlow extends AdapterView<Adapter> {
	...
	private ExtFlowIndicator mIndicator;
	...
	public ExtViewFlow(Context context) {
		super(context);
		mSideBuffer = 3;
		init();
	}

	public ExtViewFlow(Context context, int sideBuffer) {
		super(context);
		mSideBuffer = sideBuffer;
		init();
	}

	public ExtViewFlow(Context context, AttributeSet attrs) {
		super(context, attrs);
	 ...
	 * @param flowIndicator
	 */
	public void setFlowIndicator(ExtFlowIndicator flowIndicator) {
