 ...
 * 
 */
public class ExtTitleFlowIndicator extends TextView implements ExtFlowIndicator {
	...
	private ExtTitleProvider titleProvider = null;
	 ...
	 * Default constructor
	 */
	public ExtTitleFlowIndicator(Context context) {
		super(context);
	 ...
	 * @param attrs
	 */
	public ExtTitleFlowIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private void initDraw(int textColor, float textSize, int selectedColor, boolean selectedBold, float selectedSize, float footerLineHeight, int footerColor) {
		...
		//paintFooterTriangle.setStyle(Paint.Style.FILL);
	...
	protected void onDraw(Canvas canvas) {
		...
		//System.out.println("MoveTo:"+getWidth() / 2+","+(getHeight() - footerLineHeight - footerTriangleHeight));
		//System.out.println("LineTo1:"+( (getWidth() / 2) + footerTriangleHeight)+","+(getHeight() - footerLineHeight - footerTriangleHeight));
		
		//System.out.println("LineTo2:"+(getWidth() / 2 )+","+(getHeight() - footerLineHeight ));
		//System.out.println("LineTo3:"+((getWidth() / 2)+footerTriangleHeight )+","+(getHeight() - footerLineHeight ));
		
		path = new Path();
		path.moveTo(getWidth() / 2, getHeight() - footerLineHeight - footerTriangleHeight);//700,94
		path.lineTo(getWidth() / 2 + footerTriangleHeight, getHeight() - footerLineHeight - footerTriangleHeight);//740,94
		
		path.lineTo(getWidth() / 2 , getHeight() - footerLineHeight );//700,114
		
		path.lineTo(getWidth() / 2 + footerTriangleHeight, getHeight() - footerLineHeight );//740 ,114
	 ...
	 */
	@Override
	public void setViewFlow(ExtViewFlow view) {
		viewFlow = view;
	 ...
	 * @param provider
	 */
	public void setTitleProvider(ExtTitleProvider provider) {
