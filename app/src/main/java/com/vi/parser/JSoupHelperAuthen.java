	...
	public  boolean verifyAuthen(){
		  ...
		  try{
			 ...
			 //<span class="gensmall">The board requires you to be registered and logged in to view this forum.</span>
			  pass = resultHtml.indexOf("The board requires you to be registered and logged in to view this forum.") == -1;
		  }catch(Exception e){
			  e.printStackTrace();
		  }
		 return pass;
			 ...
			 while(tr.hasNext()){
				 try{
					 ...
					 if( !tdHtml.equals("") && tdHtml.indexOf("Topics") != -1){
							...
							Element linkElement = links.get(1);//default
							
							 //Check Element is Topic Title
                            Element linkElementChk = links.get(0);
							...
							Element authorE = authorElements.get(0);
							author = authorE.text();
			 ...
			 while(tablesIT.hasNext()){
				 ...
				 while(tableReplyIT.hasNext()){
					 ...
					 if( !Utils.isNull(content2).equals("")){
						 ...
						 authorRole = docContentE22 != null?docContentE22.ownText():"เธ—เธฑเนเธงเนเธ";
					  }
			     ...
			     if(no==1){
		        	title = "เธฃเธฒเธขเธฅเธฐเน€เธญเธตเธขเธ”เธเธฃเธฐเธ—เธนเน";
		        	author = "@เน€เธเนเธฒเธเธญเธเธเธฃเธฐเธ—เธนเน เธเธธเธ“ "+author+"("+authorRole+")";
		        	postDate = "@เธงเธฑเธเธ—เธตเน "+postDate;
				 }else{
					title = "เธเธงเธฒเธกเธเธดเธ”เน€เธซเนเธเธ—เธตเน : "+(no-1);
					author = "@เธเธธเธ“ "+author+"("+authorRole+")";
					postDate = "@เธงเธฑเธเธ—เธตเน "+postDate;
				 }
				 ...
				 if( !"".equalsIgnoreCase(author)){
			         ...
			         /**
			          *  เธเธงเธฒเธกเธเธดเธ”เน€เธซเนเธเธ—เธตเน :4^@ 
						 เธเธญเธเธญเธเธเธธเธ“เธเธนเนเน€เธเธตเธขเธ  เธเธนเนเธฃเธงเธเธฃเธงเธก เนเธฅเธฐเธเธนเนเธเธฑเธ”เธ—เธณเธเธ—เธเธงเธฒเธกเน€เธซเธฅเนเธฒเธเธตเนเธ”เนเธงเธขเธเนเธฐ เธ–เธทเธญเน€เธเนเธเธเธฒเธฃเน€เธเธดเนเธกเธเธธเธ“เธเนเธฒเนเธซเนเธเธฑเธเน€เธงเธเธเธตเนเธกเธฒเธเธกเธฒเธเน€เธฅเธข....เธเธญเนเธซเนเธเธณเธฅเธฑเธเนเธเนเธฅเธฐเธเธญเน€เธเนเธเนเธฃเธเธชเธเธฑเธเธชเธเธธเธเธ”เนเธงเธขเธเธฐเธเธฐ^@ 
						 @เธเธธเธ“ mey| 
			          */
			         if(contentStr != null){
